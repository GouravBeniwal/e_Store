...
const SUBCATEGORY_OPTIONS = {
  ...
  Technology: ["Mobile", "Laptop", "Accessories"],
...
const Admin = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(`${API_BASE_URL}/admin/products/${editId}`, body, {
          headers: { Authorization: `Bearer ${token}` },
        });
        toast.success("Product updated!");
      } else {
        await axios.post(`${API_BASE_URL}/admin/products`, body, {
          headers: { Authorization: `Bearer ${token}` },
        });
        ...
        <div className="admin-form-card">
          ...
          >
            <div className="form-group">
              ...
              <input
                type="text"
                placeholder="e.g. Classic Bottle"
                value={form.name}
                onChange={set("name")}
                required
              />
            ...
            <div className="form-group">
              ...
              <input
                type="text"
                placeholder="e.g. Shirts, Jeans, Chargers"
        ...
        {TABS.map((t) => (
          <button
            ...
            style={{
              ...
              border: "none",
              cursor: "pointer",
              color: tab === t ? "var(--dark)" : "var(--brown)",
              borderBottom:
                tab === t ? "2px solid var(--dark)" : "2px solid transparent",
              marginBottom: "-2px",
            }}
          >
            {t}{" "}
          ...
          >
            ...
            <tbody>
              {users.map((u) => (
                ...
                >
                  <td style={{ padding: "14px 16px", color: "var(--brown)" }}>
                    #{u.id}
                  </td>
                  ...
                  <td style={{ padding: "14px 16px" }}>
                    <span
                      style={{
                        ...
                        borderRadius: "20px",
                        fontSize: "13px",
                        background: u.is_admin ? "#1a3a5c" : "var(--sand)",
                        color: u.is_admin ? "#fff" : "var(--dark)",
                        fontWeight: 600,
                      }}
                    >
