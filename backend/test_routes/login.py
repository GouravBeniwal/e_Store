...
def login_test():
    ...
    locater.click()
    chrome.find_element('xpath',"//*[@id='root']/div/main/div/div/form/div[1]/input").send_keys("test@mail.com")
    time.sleep(1)
    chrome.find_element('xpath',"//*[@id='root']/div/main/div/div/form/div[2]/input").send_keys("Test@123")
    time.sleep(1)
